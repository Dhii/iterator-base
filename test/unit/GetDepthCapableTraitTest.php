...
use Dhii\Iterator\GetDepthCapableTrait as TestSubject;
use Xpmock\TestCase;
 ...
 * @since [*next-version*]
 */
class GetDepthCapableTraitTest extends TestCase
{
    /**
     ...
     * @since [*next-version*]
     */
    const TEST_SUBJECT_CLASSNAME = 'Dhii\Iterator\GetDepthCapableTrait';
    ...
    /**
     * Tests that `_getDepth()` works as expected.
     */
