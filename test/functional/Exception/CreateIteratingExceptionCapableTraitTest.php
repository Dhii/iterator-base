 ...
 * @since [*next-version*]
 */
class CreateIteratingExceptionCapableTraitTest extends TestCase
{
    /**
    ...
    /**
     * Tests the iterating exception creation method.
     *
     * @since [*next-version*]
     */
    public function testCreateIteratingException()
    {
        $subject = $this->createInstance();
        ...
        $result = $reflect->_createIteratingException($msg, $code, $prev);
